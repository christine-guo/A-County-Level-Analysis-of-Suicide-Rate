...
Find significant variables for random forest model 
```{r}
varImpPlot(fit.rf, sort = TRUE, n.var=min(12, nrow(fit.rf$importance)), main = "Significant Variables for Random Forest")
